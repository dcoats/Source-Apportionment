##### Producing profiles with high volatility   (see profiles5high.R for low volatility)
...
is.matrix(gas)
gas<-gas[-(121:124),]
gasdir<-rdirichlet(1,c(.68,.68,.68,.68))
...
is.matrix(diesel)
dieseldir<-rdirichlet(1,rep(.38,15)))
